...
<body>
        ...
        <div class="header">
            ...
            <div class="center">
                <ul class="links">
                    ...
                    <li><a href="../htmls/admin.php">Създай събитие</a></li>
                </ul>
            </div>
            ...
            <div class="left">
                <div class="search-bar">
                    ...
                    <i class="fa-solid fa-magnifying-glass" id="search-g"></i>
                </div>
                <a href="../htmls/log in.php"><i class="fa-solid fa-circle-user"></i></a>
            </div>
        </div>
    </nav>
    <!-- nav end -->
    ...
    <footer>
        ...
        <div class="footer-text">
            <p>Този уебсайт е каталог за събития. Ние не организираме, управляваме или определяме цените на представените прояви. Информацията е предоставена от трети страни и ние не носим отговорност за неточности или промени. За актуални детайли, цени и управлението на събитията се обръщайте директно към официалните организатори. Билети закупувайте единствено чрез проверени и оторизирани платформи! При нередности, моля да ни информирате!

            </p>
        </div>
        <div class="footer-bottom">
            <p>Copyright &copy2026 Bulgaria Events</p>
        </div>
    </footer>
